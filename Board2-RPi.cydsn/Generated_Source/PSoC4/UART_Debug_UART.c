...
void UART_Debug_UartPostEnable(void)
{
    ...
    if (UART_Debug_CHECK_TX_SDA_MISO_PIN_USED)
    {
        ...
        UART_Debug_SET_HSIOM_SEL(UART_Debug_TX_SDA_MISO_HSIOM_REG, UART_Debug_TX_SDA_MISO_HSIOM_MASK,
                                       UART_Debug_TX_SDA_MISO_HSIOM_POS, UART_Debug_HSIOM_UART_SEL);
    }
    ...
    if (UART_Debug_CHECK_RTS_SS0_PIN_USED)
    {
        ...
        UART_Debug_SET_HSIOM_SEL(UART_Debug_RTS_SS0_HSIOM_REG, UART_Debug_RTS_SS0_HSIOM_MASK,
                                       UART_Debug_RTS_SS0_HSIOM_POS, UART_Debug_HSIOM_UART_SEL);
    }
    ...
    UART_Debug_SET_HSIOM_SEL(UART_Debug_TX_HSIOM_REG, UART_Debug_TX_HSIOM_MASK,
                                   UART_Debug_TX_HSIOM_POS, UART_Debug_HSIOM_UART_SEL);
    ...
    UART_Debug_SET_HSIOM_SEL(UART_Debug_RTS_HSIOM_REG, UART_Debug_RTS_HSIOM_MASK,
                                   UART_Debug_RTS_HSIOM_POS, UART_Debug_HSIOM_UART_SEL);
...
void UART_Debug_UartStop(void)
{
        ...
        if (UART_Debug_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            UART_Debug_SET_HSIOM_SEL(UART_Debug_TX_SDA_MISO_HSIOM_REG, UART_Debug_TX_SDA_MISO_HSIOM_MASK,
                                           UART_Debug_TX_SDA_MISO_HSIOM_POS, UART_Debug_HSIOM_GPIO_SEL);
        }
    #endif /* (UART_Debug_TX_SDA_MISO_PIN_PIN) */
        ...
        if (UART_Debug_CHECK_RTS_SS0_PIN_USED)
        {
            ...
            /* Set GPIO to drive output pin */
            UART_Debug_SET_HSIOM_SEL(UART_Debug_RTS_SS0_HSIOM_REG, UART_Debug_RTS_SS0_HSIOM_MASK,
                                           UART_Debug_RTS_SS0_HSIOM_POS, UART_Debug_HSIOM_GPIO_SEL);
        }
        ...
        /* Set GPIO to drive output pin */
        UART_Debug_SET_HSIOM_SEL(UART_Debug_TX_HSIOM_REG, UART_Debug_TX_HSIOM_MASK,
                                       UART_Debug_TX_HSIOM_POS, UART_Debug_HSIOM_GPIO_SEL);
    #endif /* (UART_Debug_UART_TX_PIN) */
        ...
        /* Set GPIO to drive output pin */
        UART_Debug_SET_HSIOM_SEL(UART_Debug_RTS_HSIOM_REG, UART_Debug_RTS_HSIOM_MASK,
                                       UART_Debug_RTS_HSIOM_POS, UART_Debug_HSIOM_GPIO_SEL);
    #endif /* (UART_Debug_UART_RTS_PIN) */
...
void UART_Debug_UartSetRxAddressMask(uint32 addressMask)
{
    ...
    *******************************************************************************/
    void UART_Debug_UartSaveConfig(void)
    {
        ...
        */
        ...
        UART_Debug_UART_RX_CTRL_REG |= UART_Debug_UART_RX_CTRL_SKIP_START;

    #if(UART_Debug_SCB_MODE_UNCONFIG_CONST_CFG)
        #if(UART_Debug_MOSI_SCL_RX_WAKE_PIN)
            (void) UART_Debug_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt();
        #endif /* (UART_Debug_MOSI_SCL_RX_WAKE_PIN) */
    #else
    ...
    *******************************************************************************/
    CY_ISR(UART_Debug_UART_WAKEUP_ISR)
    {
        ...
        * only disabled by UART_Debug_UartRestoreConfig() call.
        */
    #if(UART_Debug_SCB_MODE_UNCONFIG_CONST_CFG)
        #if(UART_Debug_MOSI_SCL_RX_WAKE_PIN)
            (void) UART_Debug_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt();
