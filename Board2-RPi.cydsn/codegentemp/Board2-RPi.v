// ======================================================================
// Board2-RPi.v generated from TopDesign.cysch
// 03/31/2016 at 10:53
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e2286a40-b849-4eb7-9e74-f009cb65a8e3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__OnOff_Detect_Pin_net;
	wire [0:0] tmpFB_0__OnOff_Detect_Pin_net;
	wire [0:0] tmpIO_0__OnOff_Detect_Pin_net;
	electrical [0:0] tmpSIOVREF__OnOff_Detect_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("40209748-09d9-4133-8637-1381940bbcf6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OnOff_Detect_Pin
		 (.oe(tmpOE__OnOff_Detect_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OnOff_Detect_Pin_net[0:0]}),
		  .io({tmpIO_0__OnOff_Detect_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__OnOff_Detect_Pin_net),
		  .interrupt({Net_1444}),
		  .annotation({Net_1445}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__OnOff_Detect_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
