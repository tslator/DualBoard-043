...
#define EZI2C_sda_DM_ALG_HIZ         (0x00u)
#define EZI2C_sda_DM_DIG_HIZ         (0x01u)
#define EZI2C_sda_DM_RES_UP          (0x02u)
#define EZI2C_sda_DM_RES_DWN         (0x03u)
#define EZI2C_sda_DM_OD_LO           (0x04u)
#define EZI2C_sda_DM_OD_HI           (0x05u)
#define EZI2C_sda_DM_STRONG          (0x06u)
#define EZI2C_sda_DM_RES_UPDWN       (0x07u)
...
#if defined(EZI2C_sda__INTSTAT)  /* Interrupt Registers */
