// ======================================================================
// Board-KitProg.v generated from TopDesign.cysch
// 03/13/2016 at 16:29
...
module top ;
	...
	wire [0:0] tmpIO_0__HB25_PWM_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		HB25_PWM_Pin
		 (.oe(tmpOE__HB25_PWM_Pin_net),
		  ...
		  .io({tmpIO_0__HB25_PWM_Pin_net[0:0]}),
	...
	wire [0:0] tmpOE__Pin_InfraredDistance_7_net;
	wire [0:0] tmpFB_0__Pin_InfraredDistance_7_net;
	wire [0:0] tmpIO_0__Pin_InfraredDistance_7_net;
	wire [0:0] tmpINTERRUPT_0__Pin_InfraredDistance_7_net;
	electrical [0:0] tmpSIOVREF__Pin_InfraredDistance_7_net;

	cy_psoc3_pins_v1_10
		#(.id("855b4a44-223e-4391-b707-aab265b9e043"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_InfraredDistance_7
		 (.oe(tmpOE__Pin_InfraredDistance_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_InfraredDistance_7_net[0:0]}),
		  .analog({Net_1214}),
		  .io({tmpIO_0__Pin_InfraredDistance_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_InfraredDistance_7_net),
		  .interrupt({tmpINTERRUPT_0__Pin_InfraredDistance_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_InfraredDistance_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_InfraredDistance_6_net;
	wire [0:0] tmpFB_0__Pin_InfraredDistance_6_net;
	wire [0:0] tmpIO_0__Pin_InfraredDistance_6_net;
	wire [0:0] tmpINTERRUPT_0__Pin_InfraredDistance_6_net;
	electrical [0:0] tmpSIOVREF__Pin_InfraredDistance_6_net;

	cy_psoc3_pins_v1_10
		#(.id("62e7cea1-a05b-4bbb-b9de-370c397acbca"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_InfraredDistance_6
		 (.oe(tmpOE__Pin_InfraredDistance_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_InfraredDistance_6_net[0:0]}),
		  .analog({Net_1213}),
		  .io({tmpIO_0__Pin_InfraredDistance_6_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_InfraredDistance_6_net),
		  .interrupt({tmpINTERRUPT_0__Pin_InfraredDistance_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_InfraredDistance_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_InfraredDistance_5_net;
	wire [0:0] tmpFB_0__Pin_InfraredDistance_5_net;
	wire [0:0] tmpIO_0__Pin_InfraredDistance_5_net;
	wire [0:0] tmpINTERRUPT_0__Pin_InfraredDistance_5_net;
	electrical [0:0] tmpSIOVREF__Pin_InfraredDistance_5_net;

	cy_psoc3_pins_v1_10
		#(.id("75a1831f-ef97-4dc6-bae2-09fc4c498635"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_InfraredDistance_5
		 (.oe(tmpOE__Pin_InfraredDistance_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_InfraredDistance_5_net[0:0]}),
		  .analog({Net_1212}),
		  .io({tmpIO_0__Pin_InfraredDistance_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_InfraredDistance_5_net),
		  .interrupt({tmpINTERRUPT_0__Pin_InfraredDistance_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_InfraredDistance_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_InfraredDistance_4_net;
	wire [0:0] tmpFB_0__Pin_InfraredDistance_4_net;
	wire [0:0] tmpIO_0__Pin_InfraredDistance_4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_InfraredDistance_4_net;
	electrical [0:0] tmpSIOVREF__Pin_InfraredDistance_4_net;

	cy_psoc3_pins_v1_10
		#(.id("697cb1e7-ee92-4194-9f65-7fbc1bc1f0ee"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_InfraredDistance_4
		 (.oe(tmpOE__Pin_InfraredDistance_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_InfraredDistance_4_net[0:0]}),
		  .analog({Net_1211}),
		  .io({tmpIO_0__Pin_InfraredDistance_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_InfraredDistance_4_net),
		  .interrupt({tmpINTERRUPT_0__Pin_InfraredDistance_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_InfraredDistance_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("e22f29a2-ec46-46ac-8795-d17e6b70fb77"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3c5e49c-f50d-40c1-a135-abd44ebe313a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9ac54b21-663b-4cb8-901f-9fb82721512f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f238fb36-16e8-4df3-bd89-a2775f70673a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    ADC_SAR_SEQ_P4_v2_20_2 ADC_Infrared (
        .Vref(Net_783),
        .sdone(Net_784),
        .eoc(Net_785),
        .aclk(1'b0),
    ...
    SCB_P4_v3_0_3 UART_Debug (
        .interrupt(Net_463),
        .clock(1'b0),
        .rx_tr_out(Net_466),
        .tx_tr_out(Net_467));

    TCPWM_P4_v2_0_4 HCSR04_Timer (
        .stop(Net_714),
        .reload(Net_714),
        .start(Net_714),
        .count(1'b1),
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_799 or Net_800 or Net_801 or Net_802 or Net_803 or Net_804 or Net_805 or Net_806 or Net_854)
        begin
            case (Net_854[2:0])
                3'b000 :  tmp__mux_1_reg = Net_799;
                3'b001 :  tmp__mux_1_reg = Net_800;
                3'b010 :  tmp__mux_1_reg = Net_801;
                3'b011 :  tmp__mux_1_reg = Net_802;
                3'b100 :  tmp__mux_1_reg = Net_803;
                3'b101 :  tmp__mux_1_reg = Net_804;
                3'b110 :  tmp__mux_1_reg = Net_805;
                3'b111 :  tmp__mux_1_reg = Net_806;
            endcase
        end
    ...
    defparam HCSR04_Control.NumOutputs = 3;
	...
	cy_psoc3_pins_v1_10
		#(.id("fedcb41a-5931-44ec-b023-85f16970d69d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("59cca13d-3abc-404c-9b16-50b3f1dc8801"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6dd7c1e3-ff77-43bc-8f71-e07c88e72804"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("387d7767-9ffe-4e81-adfe-cd6fe3f023e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
