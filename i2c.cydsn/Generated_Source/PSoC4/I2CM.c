...
static void I2CM_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2CM_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[I2CM_RX_SCL_MOSI_PIN_INDEX] = I2CM_HSIOM_I2C_SEL;
            hsiomSel[I2CM_TX_SDA_MISO_PIN_INDEX] = I2CM_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[I2CM_RX_SCL_MOSI_PIN_INDEX] = I2CM_HSIOM_SPI_SEL;
            hsiomSel[I2CM_TX_SDA_MISO_PIN_INDEX] = I2CM_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[I2CM_TX_SDA_MISO_PIN_INDEX] = I2CM_HSIOM_UART_SEL;
                pinsDm  [I2CM_TX_SDA_MISO_PIN_INDEX] = I2CM_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[I2CM_RX_SCL_MOSI_PIN_INDEX] = I2CM_HSIOM_UART_SEL;
                    pinsDm  [I2CM_RX_SCL_MOSI_PIN_INDEX] = I2CM_PIN_DM_DIG_HIZ;
                }
