...
volatile uint32  I2CM_slWrBufSize;     /* Slave Receive buffer size  */
volatile uint32  I2CM_slWrBufIndex;    /* Slave Receive buffer Index */

/* Transmit buffer variables */
volatile uint8 * I2CM_slRdBufPtr;      /* Pointer to Transmit buffer  */
volatile uint32  I2CM_slRdBufSize;     /* Slave Transmit buffer size  */
volatile uint32  I2CM_slRdBufIndex;    /* Slave Transmit buffer Index */
volatile uint32  I2CM_slRdBufIndexTmp; /* Slave Transmit buffer Index Tmp */
volatile uint8   I2CM_slOverFlowCount; /* Slave Transmit Overflow counter */

#if (I2CM_I2C_CUSTOM_ADDRESS_HANDLER_CONST)

    uint32 (*I2CM_customAddressHandler)(void) = NULL;


    /*******************************************************************************
    * Function Name: I2CM_SetI2cAddressCustomInterruptHandler
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    void I2CM_SetI2cAddressCustomInterruptHandler(uint32 (*func) (void))
    {
        ...
        I2CM_customAddressHandler = func;
    }
#endif /* (I2CM_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */


/*******************************************************************************
* Function Name: I2CM_I2CSlaveStatus
********************************************************************************
*
* Summary:
...
{
    return((uint32) I2CM_slStatus);
}


/*******************************************************************************
* Function Name: I2CM_I2CSlaveClearReadStatus
********************************************************************************
*
* Summary:
...
uint32 I2CM_I2CSlaveClearReadStatus(void)
{
    ...
    status = ((uint32) I2CM_slStatus & I2CM_I2C_SSTAT_RD_MASK);
    I2CM_slStatus &= (uint8) ~I2CM_I2C_SSTAT_RD_CLEAR;
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveClearWriteStatus
********************************************************************************
*
* Summary:
...
uint32 I2CM_I2CSlaveClearWriteStatus(void)
{
    ...
    /* Mask of transfer complete flag and Error status */
    status = ((uint32) I2CM_slStatus & I2CM_I2C_SSTAT_WR_MASK);
    I2CM_slStatus &= (uint8) ~I2CM_I2C_SSTAT_WR_CLEAR;
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveSetAddress
********************************************************************************
*
* Summary:
...
void I2CM_I2CSlaveSetAddress(uint32 address)
{
    ...
    matchReg = I2CM_RX_MATCH_REG;

    matchReg &= ((uint32) ~I2CM_RX_MATCH_ADDR_MASK); /* Clear address bits */
    matchReg |= ((uint32)  I2CM_GET_I2C_8BIT_ADDRESS(address));

    I2CM_RX_MATCH_REG = matchReg;
}


/*******************************************************************************
* Function Name: I2CM_I2CSlaveSetAddressMask
********************************************************************************
*
* Summary:
...
void I2CM_I2CSlaveSetAddressMask(uint32 addressMask)
{
    ...
    matchReg &= ((uint32) ~I2CM_RX_MATCH_MASK_MASK); /* Clear address mask bits */
    matchReg |= ((uint32) (addressMask << I2CM_RX_MATCH_MASK_POS));
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveInitReadBuf
********************************************************************************
*
* Summary:
...
void I2CM_I2CSlaveInitReadBuf(uint8 * rdBuf, uint32 bufSize)
{
    ...
    if(NULL != rdBuf)
    {
        ...
        I2CM_slRdBufIndex    = 0u;                       /* Clear buffer index  */
        I2CM_slRdBufIndexTmp = 0u;                       /* Clear buffer index  */
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveInitWriteBuf
********************************************************************************
*
* Summary:
*  Sets the buffer pointer and size of the read buffer. This function also
...
void I2CM_I2CSlaveInitWriteBuf(uint8 * wrBuf, uint32 bufSize)
{
    ...
    if(NULL != wrBuf)
    {
        ...
        I2CM_slWrBufIndex = 0u;                       /* Clear buffer index  */
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveGetReadBufSize
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveGetWriteBufSize
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveClearReadBuf
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: I2CM_I2CSlaveClearWriteBuf
********************************************************************************
*
* Summary:
