// ======================================================================
// Board1-RPi.v generated from TopDesign.cysch
// 04/23/2016 at 14:13
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_Debug, CY_INSTANCE_SHORT_NAME=UART_Debug, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=UART_Debug, )
module SW_Tx_UART_v1_50_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0eb1dc58-f48d-4d5c-997d-aae970d9dba8/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967295, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=4294967294, InterruptOnCapture=true, InterruptOnCompare=true, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Phase_Counter, CY_INSTANCE_SHORT_NAME=Phase_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=Phase_Counter, )
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_30_1 ADC_Infrared (
        .Vref(Net_783),
        .sdone(Net_784),
        .eoc(Net_785),
        .aclk(1'b0),
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_801 or Net_802 or Net_890 or Net_891 or Net_901)
        begin
            case (Net_901[1:0])
                2'b00 :  tmp__mux_1_reg = Net_801;
                2'b01 :  tmp__mux_1_reg = Net_802;
                2'b10 :  tmp__mux_1_reg = Net_890;
                2'b11 :  tmp__mux_1_reg = Net_891;
            endcase
        end
    ...
    SCB_P4_v3_10_5 I2C_Master (
        .interrupt(Net_1472),
        .clock(1'b0),
        .rx_tr_out(Net_1474),
        .tx_tr_out(Net_1475));

    Counter_v3_0_6 Phase_Counter (
        .reset(1'b0),
        .tc(Net_1491),
        .comp(Net_1492),
        .clock(Net_75),
        ...
        .up_ndown(Net_112),
        .count(Net_1622));
    defparam Phase_Counter.CaptureMode = 0;
    defparam Phase_Counter.ClockMode = 1;
    defparam Phase_Counter.CompareMode = 1;
    defparam Phase_Counter.CompareStatusEdgeSense = 1;
    defparam Phase_Counter.EnableMode = 1;
    defparam Phase_Counter.ReloadOnCapture = 0;
    defparam Phase_Counter.ReloadOnCompare = 0;
    defparam Phase_Counter.ReloadOnOverUnder = 0;
    defparam Phase_Counter.ReloadOnReset = 1;
    defparam Phase_Counter.Resolution = 32;
    defparam Phase_Counter.RunMode = 0;
    defparam Phase_Counter.UseInterrupt = 1;

    // -- LUT Decode_Lookup start --
    if (1)
    begin : Decode_Lookup
        reg [3:0] tmp__Decode_Lookup_reg;
        wire [3:0] tmp__Decode_Lookup_ins;
        assign tmp__Decode_Lookup_ins = {Net_69,Net_70,Net_3174,Net_3173};
        always @(posedge Net_75)
        begin
            case (tmp__Decode_Lookup_ins)
                4'b0000 :  tmp__Decode_Lookup_reg = 4'b0000;
                4'b0001 :  tmp__Decode_Lookup_reg = 4'b1001;
                4'b0010 :  tmp__Decode_Lookup_reg = 4'b1110;
                4'b0011 :  tmp__Decode_Lookup_reg = 4'b0011;
                4'b0100 :  tmp__Decode_Lookup_reg = 4'b1100;
                4'b0101 :  tmp__Decode_Lookup_reg = 4'b0001;
                4'b0110 :  tmp__Decode_Lookup_reg = 4'b0010;
                4'b0111 :  tmp__Decode_Lookup_reg = 4'b1011;
                4'b1000 :  tmp__Decode_Lookup_reg = 4'b1000;
                4'b1001 :  tmp__Decode_Lookup_reg = 4'b0001;
                4'b1010 :  tmp__Decode_Lookup_reg = 4'b0010;
                4'b1011 :  tmp__Decode_Lookup_reg = 4'b1111;
                4'b1100 :  tmp__Decode_Lookup_reg = 4'b0000;
                4'b1101 :  tmp__Decode_Lookup_reg = 4'b1101;
                4'b1110 :  tmp__Decode_Lookup_reg = 4'b1010;
                4'b1111 :  tmp__Decode_Lookup_reg = 4'b0011;
            endcase
        end
        assign {Net_1622,Net_112,Net_69,Net_70} = tmp__Decode_Lookup_reg;
    end
    // -- LUT Decode_Lookup end --
	...
	assign tmpOE__bufoe_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_1573} : {Net_1573};
	...
	wire [0:0] tmpOE__Encoder_Count_Pin_net;
	wire [0:0] tmpFB_0__Encoder_Count_Pin_net;
	wire [0:0] tmpIO_0__Encoder_Count_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Encoder_Count_Pin_net;
	electrical [0:0] tmpSIOVREF__Encoder_Count_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("433adc6a-83e0-4f91-a0ad-ba87bdb40b1f"),
		  ...
		  .input_buffer_sel(2'b00))
		Encoder_Count_Pin
		 (.oe(tmpOE__Encoder_Count_Pin_net),
		  .y({Net_1622}),
		  .fb({tmpFB_0__Encoder_Count_Pin_net[0:0]}),
		  .io({tmpIO_0__Encoder_Count_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Encoder_Count_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Encoder_Count_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Encoder_Count_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
