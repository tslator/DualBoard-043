...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_20_1 ADC_Infrared (
        .Vref(Net_783),
        .sdone(Net_784),
        .eoc(Net_785),
        .aclk(1'b0),
    ...
    begin : Decode_Lookup
        ...
        assign {Net_64,Net_112,Net_69,Net_70} = tmp__Decode_Lookup_reg;
    end
